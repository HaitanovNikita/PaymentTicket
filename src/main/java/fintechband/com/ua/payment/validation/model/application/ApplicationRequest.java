...
@NoArgsConstructor
@AllArgsConstructor
@XmlRootElement(name = "APPLICATION_REQUEST")
public class ApplicationRequest implements Model {

    @XmlElement(name = "ID")
    protected long id;
    @XmlElement(name = "ROUTE",defaultValue = "1L")
    protected long route;
    @XmlElement(name = "LOCAL_DATE_TIME_DISPATCH", required = true)
    protected String  localDateTimeDispatch;
    @XmlElement(name = "STATUS",defaultValue = "1L")
